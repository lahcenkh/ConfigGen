"""Entry point: QApplication, login loop, window icon (§1).

The window icon itself lands in Phase 15 (packaging) once there's an
actual icon file to point at; nothing here hardcodes a path that doesn't
exist yet.
"""
...
from configgen.paths import schemas_dir, users_db_path
